...
const routeAliases = {
  ...
  Media: 'Media',
  Sermons: 'Sermons',
  'Watch Sermons': 'Sermons',
  'Audio Messages': 'Sermons',
  'Live Stream': 'Media',
  'YouTube Channel': 'Media',
  Ministries: 'Ministries',
  "Married's": "Married's Ministry",
  "Married's Ministry": "Married's Ministry",
  Youth: 'Youth Ministry',
  'Youth Ministry': 'Youth Ministry',
  Children: "Children's Ministry",
  "Children's Ministry": "Children's Ministry",
  'Discipleship Schools': 'Discipleship Ministry',
  'Discipleship Ministry': 'Discipleship Ministry',
  'Northern Discipleship School': 'Northern Discipleship School',
  'Central Discipleship School': 'Central Discipleship School',
  'Western Discipleship School': 'Western Discipleship School',
  Events: 'Events',
  Testimonies: 'Testimonies',
  'Written Testimonies': 'Written Testimonies',
  'Audio Testimonies': 'Audio Testimonies',
  'Video Testimonies': 'Video Testimonies',
  Prayer: 'Prayer',
...
const slugRouteMap = {
  ...
  sermons: 'Sermons',
  ministries: 'Ministries',
  marrieds: "Married's Ministry",
  'marrieds-ministry': "Married's Ministry",
  youth: 'Youth Ministry',
  'youth-ministry': 'Youth Ministry',
  children: "Children's Ministry",
  'childrens-ministry': "Children's Ministry",
  'children-ministry': "Children's Ministry",
  discipleship: 'Discipleship Ministry',
  'discipleship-schools': 'Discipleship Ministry',
  'discipleship-ministry': 'Discipleship Ministry',
  'northern-discipleship-school': 'Northern Discipleship School',
  'central-discipleship-school': 'Central Discipleship School',
...
function goToPage(page) {
  currentPage = normalizeRoute(page);
  faithPaused = false;
  if (window.location.protocol !== 'file:') {
    window.history.pushState({}, '', currentPage === 'Home' ? '/' : '/' + slugifyPage(currentPage));
  }
  render();
...
function handleGlobalPageClicks(event) {
  const item = event.target.closest('[data-page]');
  if (!item) return;
  const requested = item.getAttribute('data-page');
  if (!requested) return;
  event.preventDefault();
  currentPage = normalizeRoute(requested);
  window.history.pushState({}, '', currentPage === 'Home' ? '/' : '/' + slugifyPage(currentPage));
  render();
}
document.addEventListener('click', handleGlobalPageClicks);
